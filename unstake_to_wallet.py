...
def recycle_register(wallet_name, threshold, hotkey,netuid):
    ...
    if recycle_cost is not None and recycle_cost < threshold:
        ...
        # #Send message if registration is successful
        # registered_regex = ".*(?<!Already )\bRegistered\b"
        # child.expect(registered_regex, timeout=120)
...
if __name__ == "__main__":
    ...
    try:
        ...
        print (f"Exception trying to unstake to wallet - {str(e)}")